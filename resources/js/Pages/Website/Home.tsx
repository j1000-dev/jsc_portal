...
export default function Home() {
    return (
        <div className="flex flex-col items-center">
            <img className="py-10" src="/img/sports-saves-lives.jpg" width={1100} />
                ...
                <div className="col-span-3">
                    <article className="max-w-3xl w-full px-4">
                        ...
                        <div className="mx-auto">
                            ...
                            <div className="section">
                                Mark Tourigny<br></br>
                                Founding Director and President<br></br>
                                Jerome Outreach Society<br></br>
                                604-684-2139<br></br>
                                <a href="mailto:mark.tourigny@gmail.com" className="hover:underline text-sky-600 decoration-sky-600">mark.tourigny@gmail.com</a><br></br>
                                <Link href="/" className="hover:underline text-sky-600 decoration-sky-600">www.jeromeoutreach.com</Link><br></br>
                            </div>
                        </div>
                    </article>     
                </div>
