            ...
            <article className="max-w-3xl w-full px-4">
                ...
                <div className="mx-auto">
                    ...
                    <div className="section leading-loose">
                        For a more detailed and intimate biography by Valerie Jerome, <a className="text-sky-600 hover:underline decoration-sky-600" href="/storage/pdf/valeries-bio-for-harry-jerome.pdf" target="_blank">click here</a>.
                    </div>
                    <div className="section leading-loose">
